...
function SalaryCard({ title, description, icon, href, color }: SalaryCardProps) {
  ...
  return (
    <Card
      className={`p-6 cursor-pointer transition-all duration-200 hover:scale-105 hover:shadow-lg ${color} dark:bg-gray-800 dark:hover:bg-gray-700`}
      onClick={() => router.push(href)}
    >
      <div className="flex items-start space-x-4">
        <div className="p-3 rounded-full bg-background dark:bg-gray-900">
          {icon}
        </div>
        <div>
